      ...
      >
        ...
        <main style={{ display: "flex", flexDirection: "column", gap: D.sectionY * 1.4 }}>
          ...
          >
            ...
            {mode === "full" && (
              <p style={textPP(D)}>
                Two different problems, one consistent approach: find where the
                interface is asking users to do work the software could do instead,
                and fix it. Iterative work like this is where the product feels most
                like it's on the user's side.
              </p>
            )}
          </section>
